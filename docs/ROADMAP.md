...
>
> 🟦 L08 **đang học — mới xong lý thuyết (NES-90), chưa có execution-substitute nào.** Khác với L05/L06/L07: live ticket của L08 (NES-9/NES-90/NES-91/NES-93) **không có ngoại lệ execution-substitute nào được cấp**, nên `docs/lessons/08-schema-migrations-seed/README.md` chỉ là lý thuyết + schema/seed minh hoạ — `prisma/schema.prisma` chưa đổi, chưa có migration hay seed script nào, quiz chưa được trả lời. L08 chuyển ✅ chỉ sau khi NES-91 (hands-on, Hien Duong tự làm) và NES-93 (review/quiz, tự trả lời) hoàn thành thật và PR merge — không sớm hơn.
