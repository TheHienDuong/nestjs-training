...
| **TypeORM**             | Closest to the NestJS docs; `@InjectRepository` teaches how DI works with data; used by many Vietnamese companies                                             | Learning a new ORM and new framework at the at the same time → hard to tell where errors come from; decorator-based entities are easy to confuse with Nest decorators | Learning two new variables at the at the same time slows down the learning process |
| **Both in parallel**    | Maximum coverage                                                                                                                                              | Double the workload, easy to abandon                                                                                                                                  | Not suitable for beginners                                                         |
